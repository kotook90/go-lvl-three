/*
Интерактивная реализация crawler’а по адресу
Код приложения для перебора веб страниц:
...
func (r requester) GetPage(ctx context.Context, url string) (Page, error) {
	cl := &http.Client{Timeout: r.timeout}
...
const startUrl = "https://pikabu.ru"
...
func main() {
	...
	//	r = NewRequestWithDelay(time.Second, r)
