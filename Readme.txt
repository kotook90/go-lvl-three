Добавьте в программу для поиска дубликатов (либо же краулер разработанный на первом занятии), разработанную в рамках проектной работы на предыдущем модуле логи.
